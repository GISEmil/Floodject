...
\ctparttext{Introducing the project and it's various tidbits, have-beens and what-nots.} % Text on the Part 1 page describing  the content in Part 1

\part{The boring stuff} % First part of the thesis
...
\ctparttext{Introducing the various parts of theory used throughout the report.} % Text on the Part 2 page describing the content in Part 2

\part{The good stuff} % Second part of the thesis

\include{Chapters/Theory} % Chapter 2
\include{Chapters/Analysis} % Chapter 3
