...
%\setbibpreamble{} % Uncomment to include a preamble to the bibliography - some text before the rxeference list starts
...
\cleardoublepage\include{Chapters/front_thingy}
%\cleardoublepage\include{Chapters/TitlepageEn} % Abstract page
